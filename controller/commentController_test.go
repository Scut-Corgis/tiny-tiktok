...
func TestCommentAction(t *testing.T) {
	token := "token=" + jwt.GenerateToken("qly", 1090)

	// 评论操作——添加评论
	url1 := "http://127.0.0.1:8080/douyin/comment/action/?video_id=1000&action_type=1&comment_text=fuck"
	method1 := "POST"
...
func TestCommentList(t *testing.T) {
	token := jwt.GenerateToken("qly", 1090)
